...
export default function VehicleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* TAB 1: DIGITAL VEHICLE MILEAGE LEDGER (Prompt #13) */}
      {activeTab === 'ledger' && (
        <div className="space-y-6">
          ...
          {/* Immutable Trip Ledger Table matching Prompt #13 */}
      ...
      {/* Physical Odometer Verification Modal matching Prompt #11 */}
      {showVerifyModal && (
